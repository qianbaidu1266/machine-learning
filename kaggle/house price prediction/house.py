# -*- coding: utf-8 -*-
"""
Created on Sat Jul 28 22:29:37 2018
...
print(imp.sort_values(['score'], ascending=[0]))  # 按照特征重要性, 进行降序排列, 最重要的特征在最前面
...
subm.to_csv('data/RandomForest-submission1.csv', index=None)